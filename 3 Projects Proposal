...
**Tagline:** Opening the weblink will open up portals for monsters to attack New Haven; defend the world by playing three rounds of 2048 in a local co-op session (up to 3 players on one keyboard).  
**Major user journeys**
...
**Core MVP features**
1. Surprise alarm landing animation showing monster approach.  
2. 2048 gameplay with visual bullet effects for merges; 2048 triggers an ultimate attack; each monster requires three rounds.  
...
**Major user journeys**
- **Poster:** Quick Post → choose anonymous or identity → accept suggested tags → post to board.  
- **Reader:** Browse trending posts, filter by tag/board, view a poster’s public history if available.  
- **Admin:** Moderate reports and manage tag rules.  
**Core MVP features**
...
**Backend note:** Support user accounts (optional), profile picture, and a user’s history of past posts (Postgres).

---

### 3) New Haven Crime & Safety Map (reduced scope)
...
- **Admin:** Upload cleaned CSV historical data, moderate submissions.  
**Core MVP features**
